    ...
    <div class="form-group mb-0">
      <div class="input-group input-group-alternative search-input" style="">
        ...
        <div class="autocom-box" style="">
          <li>
            <a href="{{url('/ompany-profile',['company_name'=> 'le valois'])}}" class="text-muted">
          ...
          <li>
            <a href="/" class="text-muted">
                <i class="ni ni-square-pin" style="font-size:18px;padding-right:10px;margin-left:5px;"></i>
                Littoral, Douala
            </a>
          </li>
          <li>
